...
!define PRODUCT_VERSION "1.10.1-RC10"
...
Section "Dokany v1.0" SEC03
  File "..\..\encfs-bin\DokanSetup_redist-1.0.0.5000.exe"
  ExecWait "$INSTDIR\DokanSetup_redist-1.0.0.5000.exe /install /quiet"
SectionEnd
...
Section "encfs" SEC04
  ...
  Delete $INSTDIR\DokanSetup_redist-1.0.0.5000.exe
SectionEnd
